  ...
  results: [
    {
      ...
      formatted_address: 'R. Riachuelo, 243 - Santa Teresa, Rio de Janeiro - RJ, 20230-011, Brazil',
      geometry: {
        bounds: {
...
const integrationServiceImplValidMock = {
  getGeoLocalization: (address) => {
    return geoCodedAddresses[Number.parseInt(`${address.postalCode}${address.number}`)];
  },
};
...
const expectedResponseFromProcessDistance = [
  {
    ...
    orderedDistanceList: [
      {
        distanceBetween: 5,
        to: 'R. Riachuelo, 243 - Santa Teresa, Rio de Janeiro - RJ, 20230-011, Brazil',
      },
      {
  ...
  {
    address: 'R. Riachuelo, 243 - Santa Teresa, Rio de Janeiro - RJ, 20230-011, Brazil',
    orderedDistanceList: [
      {
