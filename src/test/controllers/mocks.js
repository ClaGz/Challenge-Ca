    ...
    results: [
      {
        ...
        formatted_address:
          "R. Riachuelo, 333 - Santa Teresa, Rio de Janeiro - RJ, 20230-011, Brazil",
        geometry: {
          bounds: {
...
const localizationServiceMock = {
  ...
  processDistanceBeetweenCodedAddresses: () =>
    validResponseForProcessDistanceBeetweenCodedAddresses,
};
